    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Litecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  mjrcoind [options]                     " + "\n" +
                  "  mjrcoind [options] <command> [params]  " + _("Send command to -server or mjrcoind") + "\n" +
                  "  mjrcoind [options] help                " + _("List commands") + "\n" +
                  "  mjrcoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "mjrcoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: mjrcoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: mjrcoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 55883 or testnet: 155883)") + "\n" +

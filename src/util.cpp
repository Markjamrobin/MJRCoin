...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "mjrcoin.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "mjrcoind.pid"));

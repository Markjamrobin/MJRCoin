...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("mjrcoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("mjrcoin://"))
    {
        uri.replace(0, 11, "mjrcoin:");
    }
...
{
    return GetAutostartDir() / "mjrcoin.desktop";
}
    ...
    QMessageBox(parent)
{
    header = tr("Litecoin-Qt") + " " + tr("version") + " " +
        ...
        tr("Usage:") + "\n" +
        "  mjrcoin-qt [" + tr("command-line options") + "]                     " + "\n";
